...
QUESTIONS = [
    ...
    {"id": 10, "question": "Что делать после того как нашли новый тендер?", "question_type": "procedure"},
    ...
    {"id": 23, "question": "куда нужно класть файлы при регистрации архивов", "question_type": "fact"},
    ...
    {"id": 27, "question": "Где нужно хранить рабочую документацию", "question_type": "fact"},
    ...
    {"id": 49, "question": "Что такое верификация поставки?", "question_type": "definition"},
    {"id": 50, "question": "Что такое субподрядная работа?", "question_type": "definition"},
